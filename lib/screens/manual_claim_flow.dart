...
class _ManualClaimFlowState extends State<ManualClaimFlow> {
  ...
  void _finishFlow() {
    final bool isAutoApprove = _selectedDisruption == 'Severe Weather' || 
    ...
    final Map<String, dynamic> newClaim = {
      ...
      'isAuto': false,
      'description': _disruptionTypes.firstWhere((d) => d['title'] == _selectedDisruption)['desc'],
    };
                ...
                return Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: active ? AppTheme.primary : AppTheme.dividerOf(context),
  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
        ...
        ..._disruptionTypes.map((type) => GestureDetector(
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
            ...
            hintText: 'e.g. Heavy rain in Velachery blocked all routes from 6pm to 9pm',
  ...
  Widget _buildStep2() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        _buildEvidenceItem('GPS location log', 'Verified in zone during disruption window'),
        _buildEvidenceItem('Platform activity record', 'Zero completed orders during claimed period'),
        _buildEvidenceItem('Weather data', 'IMD confirms 58mm rainfall in your zone'),
      ],
    );
  }
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Claim Reference', style: TextStyle(color: AppTheme.textSecondaryOf(context))),
                        Text('CLM/261203/$refPrefix****', style: const TextStyle(fontWeight: FontWeight.w800, fontFamily: 'monospace')),
                      ],
                    ),
                    const Divider(height: 32),
                    Row(
                      children: [
                        Icon(isAutoApprove ? Icons.bolt : Icons.info_outline, size: 16, color: color),

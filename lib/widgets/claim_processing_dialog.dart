...
class _ClaimProcessingDialogState extends State<ClaimProcessingDialog> {
  ...
  void _finish() {
    final bool isAutoApprove =
        widget.selectedReason == 'Heavy Rain / Waterlogging' ||
    ...
    final Map<String, dynamic> newClaim = {
      ...
      'title': widget.selectedReason == 'Select a reason'
          ? 'Other Disruption'
      ...
      'isAuto': false,
      'claim_description': 'Submitted via Apply Form',
    };
